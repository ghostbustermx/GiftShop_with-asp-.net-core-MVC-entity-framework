...
namespace PinnacleSoftware.Controllers
{
    public class ProductosController : Controller
    {
        ...
        /*public async Task<List<SelectListItem>> GetCategory()
        {
            ...
            categoriasLista = _categoria.CategoriaID;

            //categoriasLista = new SelectList(_context.Categoria, "CategoriaID", "CategoriaID", _categoria.CategoriaID);
        ...
        public async Task<IActionResult> Create([Bind("ProductoID,Nombre,Descripcion,Costo,Estado,CategoriaID")] Producto producto)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var producto = await _context.Producto.SingleOrDefaultAsync(m => m.ProductoID == id);
            if (producto == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductoID,Nombre,Descripcion,Costo,Estado,CategoriaID")] Producto producto)
        {
